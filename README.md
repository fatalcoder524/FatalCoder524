### user@life:~$ yes | ./fatalcoder524 <br> Greetings Earthling! Or should I say… fellow Stack Overflow addict? 👋 <br> Nah! You’re probably too young to remember when we had to debug without AI—and actually trusted the answers we copy-pasted from the internet. 😂 <br> Do you Want to know more about this alien👽? [Y/N] : Y <br> Use the Following options to get more info: <br> &nbsp; &nbsp; &nbsp;--probe-brain : Get Info on what is running in my mind😵‍💫🧠 <br> &nbsp; &nbsp; &nbsp;--get-info : Get Info on what is happening in my life🧩 <br> &nbsp; &nbsp; &nbsp;--tech-stack-known : Get Info on what I know by abducting people🛸 <br> &nbsp; &nbsp; &nbsp;--tech-stack-intrested : Get Info on what I'm learning by abducting people🛸 <br> &nbsp; &nbsp; &nbsp;--github-stats : Decode the mysterious green-square-patterns known as "GitHub contributions" 👽🛸📈 <br> &nbsp; &nbsp; &nbsp;--top-repos : Witness the rare repositories that survived my infamous "rm -rf ./hope" phase 🌌🗑️ <br> &nbsp; &nbsp; &nbsp;--contact-me : Initiate first contact with FatalCoder524 🛸👽

### user@life:~$ ./fatalcoder524 --probe-brain 
50% caffeine, 50% regret, 100% will Google 'how to quit programming' at 3 AM.

### user@life:~$ ./fatalcoder524 --get-info <br> My Life As of Now 🌱
- 🔭 I’m currently working on Satellite Applications 📡 @ <a href="https://tejasnetworks.com/">Tejas Networks</a> as an Embedded Engineer.
- 🌱 I’m currently learning about Android Linux Kernel internals & building along with low-level data transmission protocols.
- 👯 I’m looking to collaborate on Android Linux Kernel, and anything RF-related.

### user@life:~$ ./fatalcoder524 --top-repos <br> Actively Working Repos <br> Warning: Contains projects written under caffeine-induced delirium😵‍💫
...
[![](https://img.shields.io/badge/Org%20Member-💖%20EmberHeart--Kernels-0b0)](https://github.com/EmberHeart-Kernels)
...
1. 🗣 Commented on [#1227](https://github.com/KernelSU-Next/KernelSU-Next/issues/1227#issuecomment-4320120286) in [KernelSU-Next/KernelSU-Next](https://github.com/KernelSU-Next/KernelSU-Next)
2. 🔒 Closed issue [#192](https://github.com/WildKernels/OnePlus_KernelSU_SUSFS/issues/192) in [WildKernels/OnePlus_KernelSU_SUSFS](https://github.com/WildKernels/OnePlus_KernelSU_SUSFS)
3. ❗ Opened issue [#2](https://github.com/OnePlusOSS/android_kernel_modules_and_devicetree_oneplus_sm8850/issues/2) in [OnePlusOSS/android_kernel_modules_and_devicetree_oneplus_sm8850](https://github.com/OnePlusOSS/android_kernel_modules_and_devicetree_oneplus_sm8850)
4. ❗ Opened issue [#10](https://github.com/OnePlusOSS/android_kernel_modules_and_devicetree_oneplus_sm8750/issues/10) in [OnePlusOSS/android_kernel_modules_and_devicetree_oneplus_sm8750](https://github.com/OnePlusOSS/android_kernel_modules_and_devicetree_oneplus_sm8750)
5. 🗣 Commented on [#192](https://github.com/WildKernels/OnePlus_KernelSU_SUSFS/issues/192#issuecomment-4308678125) in [WildKernels/OnePlus_KernelSU_SUSFS](https://github.com/WildKernels/OnePlus_KernelSU_SUSFS)
6. 🗣 Commented on [#192](https://github.com/WildKernels/OnePlus_KernelSU_SUSFS/issues/192#issuecomment-4306413122) in [WildKernels/OnePlus_KernelSU_SUSFS](https://github.com/WildKernels/OnePlus_KernelSU_SUSFS)
7. 🗣 Commented on [#192](https://github.com/WildKernels/OnePlus_KernelSU_SUSFS/issues/192#issuecomment-4304995355) in [WildKernels/OnePlus_KernelSU_SUSFS](https://github.com/WildKernels/OnePlus_KernelSU_SUSFS)
